...
var http = _interopDefault(require('choo/http'));
...
const uiModel = {
    ...
    reducers: {
        enableSection: (name, state) => state.enabledSections.includes(name) ? state : _extends({}, state, {
            enabledSections: state.enabledSections.concat([name])
        }),
        disableSection: (name, state) => _extends({}, state, {
            enabledSections: state.enabledSections.filter(item => item !== name)
        }),
        selectSection: (name, state) => _extends({}, state, {
            selectedSection: name
        }),
        setFbPages: (facebookPages, state) => _extends({}, state, {
            facebookPages
        }),
        selectReply: (replyKey, state) => _extends({}, state, {
            selectedReply: replyKey
        }),
        selectMutedUser: (index, state) => _extends({}, state, {
            selectedMutedUsers: state.selectedMutedUsers.concat([index])
        }),
        deselectMutedUser: (index, state) => _extends({}, state, {
            selectedMutedUsers: state.selectedMutedUsers.filter(i => i !== index)
        }),
        setSelectedMutedUsers: (data, state) => _extends({}, state, {
...
const botModel = {
    ...
    reducers: {
        set: data => data,
        setFacebookPage: (page, state) => _extends({}, state, {
        ...
        setVtexStore: (update, state) => _extends({}, state, {
...
const repliesModel = {
    ...
    state: {
        ...
        receipt: {
            ...
            template: 'button',
            text: 'A nota fiscal é enviada junto ao pedido. Você pode pedir' + 'uma segunda via clicando no botão abaixo.',
            buttons: ['printReceiptLink', 'backToMenu', 'talkToHuman']
        },
        returns: {
            template: 'button',
            text: 'O prazo para solicitação de troca é de 30 dias corridos,' + ' a contar da data de recebimento do produto.',
...
const createApiModel = config => ({
    ...
    reducers: {
        set: data => data,
        updateBotBegin: (data, state) => _extends({}, state, {
            updatingBot: true
        }),
        updateBotEnd: (data, state) => _extends({}, state, {
            updatingBot: false
        }),
        loadingUsersBegin: (data, state) => _extends({}, state, {
            loadingUsers: true
        }),
        loadingUsersEnd: (data, state) => _extends({}, state, {
            loadingUsers: false
        }),
        loadingRepliesBegin: (data, state) => _extends({}, state, {
            loadingReplies: true
        }),
        loadingRepliesEnd: (data, state) => _extends({}, state, {
            loadingReplies: false
        })
    },
    effects: {
        ...
        updateBot: (data, state, send, done) => {
            ...
            const update = _extends({}, facebookUpdate, vtexUpdate, repliesUpdate);
...
const mainCss = (require('insert-css')("._2cb49787 {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n}\n\n._2cb49787 .checkboxRow {\n    width: 20px;\n}\n\n._2cb49787 .toolbarRefreshButton {\n    text-align: right;\n}\n\n._2cb49787 .user-chat-bubble {\n    border-radius: 1.3em 1.3em 0 1.3em;\n    color: #fff;\n    height: 35px;\n    background-color: #0084ff;\n    width: auto;\n    font-size: 14px;\n    text-align: right;\n    margin: 1px 0;\n    padding: 6px 12px;\n    overflow: hidden;\n    clear: right;\n    float: right;\n    word-wrap: break-word;\n}\n\n._2cb49787 .reply-container {\n    clear: both;\n}\n\n._2cb49787 .reply-body {\n    color: #000;\n    width: auto;\n    font-size: 14px;\n    padding: 6px 12px;\n    word-wrap: break-word;\n    outline: none;\n}\n\n._2cb49787 .reply-template-generic .reply-body {\n    border: 1px solid #cbcbcb;\n    border-bottom: none;\n}\n\n._2cb49787 .reply-title,\n._2cb49787 .reply-text {\n    display: block;\n    border: none;\n    width: 100%;\n    padding-left: 0;\n    outline: none;\n    resize: none;\n}\n\n._2cb49787 .reply-title {\n    font-weight: 700;\n}\n._2cb49787 .reply-template-button .reply-text,\n._2cb49787 .reply-template-text .reply-text,\n._2cb49787 .chat-bubble {\n    border-radius: 1.3em 1.3em 1.3em 0;\n    min-height: 35px;\n    background: none;\n    background-color: #f1f0f0;\n    color: #000;\n    font-size: 14px;\n    margin: 1px 0;\n    padding: 6px 12px;\n    clear: left;\n    float: left;\n    word-wrap: break-word;\n}\n._2cb49787 .reply-footer {\n    clear: both;\n    border: 1px solid #cbcbcb;\n    overflow: hidden;\n}\n\n._2cb49787 .reply-template-button .reply-footer {\n    border-radius: 1.3em;\n}\n\n._2cb49787 .reply-template-generic .reply-footer {\n    border-radius: 0 0 1.3em 1.3em;\n}\n\n._2cb49787 .reply-button {\n    margin-top: -1px;\n    text-align: center;\n    color: blue !important;\n    font-size: 14px;\n    width: 100%;\n    padding: 6px 12px;\n    border: none;\n    border-top: 1px solid #cbcbcb;\n    text-transform: uppercase;\n    background: none;\n}\n\n._2cb49787 .reply-template-text .reply-button {\n    border: 1px solid #cbcbcb;\n}") || true) && "_2cb49787";
...
const loginCss = (require('insert-css')("._480c0f06 .login {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n}") || true) && "_480c0f06";
const classes = {
    subtitle: 'lead',
...
var repliesContent = ((state, send) => {
    ...
    const content = repliesFormComponent(selectedReplyKey, state.replies, selectedReply, classes$1, messages.replies.ecommerce, state.api.loadingReplies || state.api.updatingBot, onChange, onSubmit);
    return view(content, {
